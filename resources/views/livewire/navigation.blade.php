    ...
    <div class="relative flex items-center justify-between h-16">
      ...
      <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <a href="/" class="flex-shrink-0 flex items-center">
          <img class="block lg:hidden h-8 w-auto" src="https://cdn.worldvectorlogo.com/logos/laravel-vapor.svg" alt="Workflow">
          <img class="hidden lg:block h-8 w-auto" src="https://cdn.worldvectorlogo.com/logos/laravel-vapor.svg" alt="Workflow">
        </a>
